## Learn how to create your first AppHelloWorldComponent with @lirx/dom
...
<details>
  ...
  And then install `@lirx/dom` and `rx-js-light`
  ...
  Finally, delete the content of the file `src/index.ts` and create a `src/hello-world.component.ts` one.
