...
import { createReactiveAsyncNode } from '../../../reactive-dom/template/reactive-async-node/create-reactive-async-node';
...
export const DEFAULT_REQUIRE_EXTERNAL_FUNCTION_CONSTANTS_TO_IMPORT = {
  ...
  setCaseInsensitiveReactiveProperty,
