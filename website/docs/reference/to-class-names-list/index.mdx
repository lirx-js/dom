---
tags: [FUNCTION, CSS CLASS]
---

# toClassNamesList

- **[SOURCE FILE](https://github.com/lirx-js/dom/tree/main/src/dom-manipulation/virtual-nodes/virtual-reactive-element-node/members/class/to-class-names-list.ts)**
